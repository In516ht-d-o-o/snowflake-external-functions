...
namespace SnowflakeExternalFunctions.HelperClasses.Authentication
{
    ...
    public class AuthenticationConfig
    {
        ...
        /// </summary>
        public string Instance { get; set; } = Environment.GetEnvironmentVariable("Instance", EnvironmentVariableTarget.Process);
        ...
        /// </summary>
        public string Tenant { get; set; } = Environment.GetEnvironmentVariable("Tenant", EnvironmentVariableTarget.Process);

        /// <summary>
        /// Guid used by the application to uniquely identify itself to Azure AD
        /// </summary>
        public string ClientId { get; set; } = Environment.GetEnvironmentVariable("ClientId", EnvironmentVariableTarget.Process);
        ...
        /// <remarks> 
        public string ClientSecret { get; set; } = Environment.GetEnvironmentVariable("ClientSecret", EnvironmentVariableTarget.Process);
